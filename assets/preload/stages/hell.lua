function onCreate()
	...
	scaleObject("agentAppear", 1.8, 1.8)
	...
	scaleObject("soldatAppear", 1.7, 1.7)
	...
	scaleObject("barricada", 3.24, 3.24)
	...
	scaleObject("barricada_hank", 6.48, 6.48)
